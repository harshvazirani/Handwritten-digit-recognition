...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        p = np.transpose(self.hidden_to_output_weights)*output_layer_error
        q = np.vectorize(rectified_linear_unit_derivative)(hidden_layer_weighted_input)
        hidden_layer_error = np.multiply(p, q)
